...
<head>
  ...
  <title>ThaNerd Parts | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="/ThaNerdParts/" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>TN</b>P</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>ThaNerd</b>Parts</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">David Collin</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  David Collin - International Nerd
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#">Consume components</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Home
        <small>Status of your components stock</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">Datasheets</span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">Pictures</span>
